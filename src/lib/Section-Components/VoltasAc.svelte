<section class="homepage-section gradient-bg-section relative">
	...
	>
		...
		>
			<enhanced:img class="z-30" src="$lib/assets/landing-page/voltas-ac.png" alt="voltas-ac" loading="lazy" />
		</div>
	...
	<h1 class="absolute top-6 left-6 text-center text-xl font-extrabold italic">VOLTAS</h1>
</section>
