...
<section class="flex flex-col gap-5">
	<div class="flex items-start justify-between gap-3">
		<div>
			<h2 class="text-base font-bold text-gray-900 mb-0.5">ImageKit Config</h2>
			<p class="text-[13px] text-copy-light m-0">Image upload configuration for product images and banners.</p>
		</div>
