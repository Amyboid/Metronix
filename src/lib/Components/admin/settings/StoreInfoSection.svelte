...
<section class="flex flex-col gap-5">
	<div class="flex items-start justify-between gap-3">
		<div>
			<h2 class="text-base font-bold text-gray-900 mb-0.5">Store Info</h2>
			<p class="text-[13px] text-copy-light m-0">Basic store details displayed across the admin panel.</p>
		</div>
