...
<div class="flex flex-col gap-5">
	...
	{#if showAdd}
		<div class="bg-surface border border-subtle rounded-[10px] px-5 py-[18px] flex flex-col gap-3.5">
			<h3 class="text-sm font-bold text-gray-900 m-0">New Product Type</h3>
			...
			<label class="flex flex-col gap-[5px]">
				...
				<input class="font-inter text-[13px] py-[7px] px-2.5 border border-subtle rounded-md bg-neutral text-gray-900 outline-none transition-colors w-full box-border focus:border-primary" bind:value={addBannerMsg} placeholder="Stay cool this summer…" />
			</label>
	...
	{:else if items.length === 0}
		<div class="py-8 text-center text-sm text-copy-light border border-dashed border-subtle rounded-[10px]">No product types yet. Add one above.</div>
	{:else}
