			...
			{:else}
				...
				{#if deleteProductCount > 0}
					...
					<div class="flex gap-2 justify-end flex-wrap">
						...
						<button class="font-inter text-[13px] font-semibold py-[7px] px-4 rounded-[7px] border border-subtle bg-surface text-copy cursor-pointer transition-colors hover:bg-canvas"   onclick={() => confirmDelete(false)}>Delete category only</button>
		...
		<div class="bg-surface border border-subtle rounded-[10px] px-5 py-[18px] flex flex-col gap-3.5">
			...
			<div class="flex gap-3 flex-wrap two-col">
				<label class="flex flex-col gap-[5px]">
					...
					<input class="font-inter text-[13px] py-[7px] px-2.5 border border-subtle rounded-md bg-neutral text-gray-900 outline-none transition-colors w-full box-border focus:border-primary" bind:value={addName} oninput={() => { addSlug = nameToSlug(addName); }} placeholder="e.g. Consumer Electronics" />
				</label>
				<label class="flex flex-col gap-[5px]">
